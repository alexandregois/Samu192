...
{
    public class SolicitarAtendimentoChatDTO
    {
        private DCSolicitarAtendimentoChatV1 solicitacao;

        internal DCSolicitarAtendimentoChatV1 Solicitacao { get { return solicitacao; } }

        public SolicitarAtendimentoChatDTO() {
            solicitacao = new DCSolicitarAtendimentoChatV1();
        }

        public SolicitarAtendimentoChatDTO(DCSolicitarAtendimentoChatV1 solicitacao)
        {
            if (solicitacao == null) solicitacao = new DCSolicitarAtendimentoChatV1();
