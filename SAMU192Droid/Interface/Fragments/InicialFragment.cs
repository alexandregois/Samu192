...
{
    public class InicialFragment : BaseFragment
    {
        public static string TAG = "Inicial";
        #region Campos de tela
        View view;
        ImageButton cmdChamar192_ligar;
        ImageButton cmdChamar192_paramim;
        ImageButton cmdChamar192_paraoutrapessoa;
        ...
        public override void HideDescendantsForAccessibility()
        {
            ...
            cmdChamar192_paramim.ImportantForAccessibility =
            cmdChamar192_paraoutrapessoa.ImportantForAccessibility =
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            try
            {
                view = inflater.Inflate(Resource.Layout.inicial, null);
                LoadScreenControls();
                LoadStubFacades();                
        ...
        internal void LoadScreenControls()
        {
            try
            {
                ...
                cmdChamar192_paramim = view.FindViewById<ImageButton>(Resource.Id.chamar192_cmd_paramim);
                cmdChamar192_paramim.Click += chamar192_cmd_paramim_Click;
                cmdChamar192_paraoutrapessoa = view.FindViewById<ImageButton>(Resource.Id.chamar192_cmd_paraoutrapessoa);
                cmdChamar192_paraoutrapessoa.Click += chamar192_cmd_paraoutrapessoa_Click;
        ...
        private void chamar192_cmd_paramim_Click(object sender, EventArgs e)
        {
            try
            {
                StubAppCenter.AppAnalytic(Enums.AnalyticsType.Ligar_ParaMim.Value, this.Tag);
                LigarEnviarPacote(false);
            }
            catch (Exception ex)
            {
        ...
        private void chamar192_cmd_paraoutrapessoa_Click(object sender, EventArgs e)
        {
            try
            {
                StubAppCenter.AppAnalytic(Enums.AnalyticsType.Ligar_ParaOutraPessoa.Value, this.Tag);
        ...
        {
            cmdChamar192_paramim.Visibility = cmdChamar192_paraoutrapessoa.Visibility = main_chamado_queixa.Visibility = main_chamado_favoritos_ll.Visibility = main_chamado_user_ll_ll.Visibility = main_seja_ll.Visibility = !show ? ViewStates.Visible : ViewStates.Gone;
            cmdChamar192_ligar.Visibility = main_fora_ll.Visibility = show ? ViewStates.Visible : ViewStates.Gone;
        ...
        {
            cmdChamar192_paramim.Visibility = cmdChamar192_paraoutrapessoa.Visibility = main_chamado_favoritos_ll.Visibility = main_chamado_queixa.Visibility = main_chamado_user_ll_ll.Visibility = main_seja_ll.Visibility = show ? ViewStates.Visible : ViewStates.Gone;
        ...
        {
            cmdChamar192_paramim.Visibility = cmdChamar192_paraoutrapessoa.Visibility = show ? ViewStates.Visible : ViewStates.Gone;
