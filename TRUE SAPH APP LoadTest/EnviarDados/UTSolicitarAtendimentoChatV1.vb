...
<TestClass()> Public Class UnitTestSolicitarAtendimentoChatV1

    <TestMethod()> Public Sub APP_DCSolicitarAtendimentoChatV1()
        ...
        Try
            ...
            Dim original As New DCSolicitarAtendimentoChatV1
            With original
                .Bairro = "Wallaby Way"
                .Cidade = "Sydney"
                .Complemento = ""
            ...
            Dim copia = New DCSolicitarAtendimentoChatV1(dados)
            ...
            Assert.IsTrue(dados(0) = DCSolicitarAtendimentoChatV1.VERSAO)
